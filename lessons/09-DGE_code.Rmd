...
>The rlog transformation of the normalized counts is only necessary for these visualization methods during this quality assessment. We will not be using these transformed counts downstream.
...
## Summary of DGE analysis workflow
...
**The C2 subcollection CGP: Chemical and genetic perturbations Gene sets that represent **
